...
<html>
<head>
    <title>Create Module | OrbitD Admin</title>
                ...
                <form id="new-module" role="form">
                    <div class="sidebar-options">
                        ...
                        <div class="form-group default">
                            ...
                            <input type="text" id="name" name="name" class="form-control" required placeholder="Name your module" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group default">
                            <div class="message">Fill out the Name &amp; Type to show more options</div>
                        </div>
                        ...
                        <div class="form-group accordion custom-accordion">
                            ...
                            <div id="custom" class="panel-collapse collapse">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="headCSS"></textarea>
                                </div>
